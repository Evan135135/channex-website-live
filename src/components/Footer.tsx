        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-slate-400">
              <li><a href="#" className="hover:text-white transition-colors font-inter">API Documentation</a></li>
              <li><a href="#" className="hover:text-white transition-colors font-inter">Integrations</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-slate-400">
              <li><a href="#" className="hover:text-white transition-colors font-inter">Help Center</a></li>
              <li><a href="#" className="hover:text-white transition-colors font-inter">Contact Sales</a></li>
              <li><a href="#" className="hover:text-white transition-colors font-inter">System Status</a></li>
              <li><a href="#" className="hover:text-white transition-colors font-inter">Security</a></li>
            </ul>
          </div>
        </div>
